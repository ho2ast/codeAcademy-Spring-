...
<body>
	...
	<jsp:include page="../include/community_topMenu.jsp" />
		...
		<div class="col-md-11">
			...
			<form action="/community/write" method="post" class="form-horizontal" id="board_write_form" name="frm" enctype="multipart/form-data" onsubmit="return check();">
				<div class="col-md-5">
				...
				<div class="col-md-5" id="file_container">
					...
					<input type="file" name="files" id="fileadd"/>
				</div>
				<c:choose>
